...
| **S-024** | `Orchestrator` | CREATE_SKILL | [create_skill.md](file:///h:/Brahma/backend/Brahma%20%5BBrain%5D/skills/brahma/create_skill.md) | **ACTIVE** | Create a new named skill, write its markdown sheet to disk, and register it live in Hunar.md. |

*<!-- DYNAMIC_SKILL_INSERTION_MARKER -->
| **S-026** | `orchestration` | SOMETHING | [something.md](file:///h:/Brahma/backend/Brahma%20%5BBrain%5D/skills/brahma/something.md) | **ACTIVE** | does everything |
| **S-025** | `Productivity` | EMAIL_SUMMARIZER | [email_summarizer.md](file:///h:/Brahma/backend/Brahma%20%5BBrain%5D/skills/brahma/email_summarizer.md) | **ACTIVE** | Summarizes the content of emails |*
