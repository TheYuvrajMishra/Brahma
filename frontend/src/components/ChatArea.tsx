    ...
    return (
        <div className="main-area flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col overflow-hidden relative">
                ...
                />
                {/* Radial Gradient Overlay to soften the background image edges */}
                <div className="absolute inset-0 pointer-events-none bg-radial from-transparent via-[#050505]/30 to-[#050505]/90 z-0" />
